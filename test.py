...
generator.load_state_dict(torch.load('src/GANTraining/samples/netG_epoch_3716_6393.pth', map_location=lambda storage, loc: storage))
...
if __name__ == '__main__':
    ...
    agent = Agent()
    game = MarioGame()
    result = game.runGame(agent, output, 20, 0, True)
    print(result)
    print("****************************************************************")
